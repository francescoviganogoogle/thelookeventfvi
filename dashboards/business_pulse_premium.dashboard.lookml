- dashboard: business_pulse_premium
  title: Business Pulse (Premium)
  layout: newspaper
  preferred_viewer: dashboards-next
  description: "An executive-grade, visually optimized edition of the Business Pulse dashboard."
  ...
  - name: "<span class='fa fa-tachometer'> Top Line Metrics</span>"
    ...
    col: 0
    body_text: |
      <div style="background: linear-gradient(135deg, #1B4965 0%, #2A6F97 100%); padding: 20px 24px; border-radius: 8px; border-left: 6px solid #E29578; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1);">
        <h1 style="color: #FFFFFF; font-size: 26px; font-weight: 700; margin: 0 0 6px 0; font-family: 'Outfit', 'Inter', sans-serif;"><i class="fa fa-tachometer" style="margin-right: 12px; color: #E29578;"></i>Top Line Performance Pulse</h1>
        <p style="color: #BEE9E8; font-size: 14px; margin: 0; font-family: 'Inter', sans-serif;">Real-time business performance indicators, sales volume, and customer acquisition metrics.</p>
      </div>
  ...
  - name: "<span class='fa fa-users'> </span> Customer Demographics"
    ...
    col: 0
    body_text: |
      <div style="background: linear-gradient(135deg, #0F172A 0%, #1E293B 100%); padding: 20px 24px; border-radius: 8px; border-left: 6px solid #62B6CB; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1);">
        <h1 style="color: #FFFFFF; font-size: 22px; font-weight: 700; margin: 0 0 6px 0; font-family: 'Outfit', 'Inter', sans-serif;"><i class="fa fa-users" style="margin-right: 12px; color: #62B6CB;"></i>Customer Demographics & Segmentation</h1>
        <p style="color: #E2E8F0; font-size: 13px; margin: 0; font-family: 'Inter', sans-serif;">Detailed breakdown of our global user base, spatial distribution, lifetime value, and behavior.</p>
      </div>
  ...
  - name: "<span class='fa fa-laptop'> </span> Web Analytics"
    ...
    col: 0
    body_text: |
      <div style="background: linear-gradient(135deg, #2A6F97 0%, #62B6CB 100%); padding: 20px 24px; border-radius: 8px; border-left: 6px solid #E29578; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1);">
        <h1 style="color: #FFFFFF; font-size: 22px; font-weight: 700; margin: 0 0 6px 0; font-family: 'Outfit', 'Inter', sans-serif;"><i class="fa fa-laptop" style="margin-right: 12px; color: #E29578;"></i>Web Traffic & Acquisition Channels</h1>
        <p style="color: #BEE9E8; font-size: 13px; margin: 0; font-family: 'Inter', sans-serif;"><b>Recommended Action:</b> Dive into high-conversion traffic sources and analyze session-to-checkout funnels to drive digital growth.</p>
      </div>
